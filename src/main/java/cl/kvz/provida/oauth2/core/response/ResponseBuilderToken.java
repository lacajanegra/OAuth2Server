...
public class ResponseBuilderToken extends ResponseBuilder {
	...
	public Response buildResponse(HttpServletRequest request, Client client)
		...
		System.out.println("desde token builder");
		...
		builder.setTokenType(OAuth.OAUTH_BEARER_TOKEN);
		builder.setAccessToken(token);
		builder.setExpiresIn(String.valueOf(client.getTimeExpiration()));
